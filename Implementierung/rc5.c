...
void rc5_cbc_enc(unsigned char *key , size_t keylen , void *buffer , size_t len , uint32_t iv ) {
  void *roundkeys;
  void *l;
  uint32_t *padbuf;
...
int rc5_cbc_dec(unsigned char *key, size_t keylen, void *buffer, size_t len, uint32_t iv) {
  void *roundkeys;
  void *l;
  uint32_t *padbuf;
  uint32_t *curblock, *lastblock;
